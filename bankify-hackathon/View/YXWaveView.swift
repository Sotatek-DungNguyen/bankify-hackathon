...
open class YXWaveView: UIView {
    ...
    @IBInspectable open var waveCurvature: CGFloat = 1.5
    /// wave speed (default: 0.6)
    @IBInspectable open var waveSpeed: CGFloat = 0.6
    /// wave height (default: 5)
    @IBInspectable open var waveHeight: CGFloat = 5
    /// real wave color
    @IBInspectable open var realWaveColor: UIColor = UIColor.red {
        didSet {
            self.realWaveLayer.fillColor = self.realWaveColor.cgColor
        }
    }
    /// mask wave color
    @IBInspectable open var maskWaveColor: UIColor = UIColor.red {
        didSet {
